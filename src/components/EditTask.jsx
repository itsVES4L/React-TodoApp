...
const EditTask = ({ setIsEditingTask, data, setTodos }) => {
  ...
  return (
    <div className="w-full text-[#84849D]">
      <div className="flex flex-col gap-5 w-full mb-6 justify-center items-center  ">
            ...
            {subTasks?.map((item, index) => {
              return (
                <div
                  ...
                  key={index}
                >
                  <span className=" text-center text-[#8d8fd2] rounded-full">
                    {" "}
                    {index + 1}{" "}
                  </span>{" "}
                  <input
                    ...
                    onChange={(e) => {
                      const value = e.target.value;
                      // Replacement of Changed Data :
                      setSubTasks((prevSubTasks) => {
                        // create a new copy:
                        const newSubTasks = [...prevSubTasks];
                        // update the necessary index:
                        newSubTasks[index] = {
                          ...newSubTasks[index],
                          subTask: value,
                        };
        ...
        <div
          className="flex w-[50%] md:w-[70%] mr-8  md:px-0
